function [CLa,centerPresX,totalLift,dragForce] = supersonicFin(bodyDiameter,finResolution,Mach,attackAng,finDims,k)
liftForce = 0;
dragForce = 0;
pitchMoment = 0;

numFins = finDims(1); rootChord = finDims(2)/100; tipChord = finDims(3)/100; semispan = finDims(4)/100; leadTaper = finDims(6)/100; trailTaper = finDims(7)/100; distNoseTip = finDims(8)/100;
